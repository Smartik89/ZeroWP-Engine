...
* Admin page
*
* Create a backend page. This class does not fill the page with content, the `page()`
* method must be used to insert content.
*
* @since 1.0
*
*/
namespace Zwe\Backend;
...
class Page{
	...
	public function pageSettings(){
		...
		//Merge with other custom settings
		$menu_settings = wp_parse_args( $menu_settings, $settings );
